    ...
    return (
        <>
            ...
            <div className="lg:usablesize absolute right-0 top-0 flex h-screen w-full flex-col items-center gap-10">
                <div className="absolute top-[100px] w-[996px] max-w-[90%] 2xl:w-[1400px]">
                    <div className="mx-auto mb-5 flex w-full items-center justify-between">
                        <span className="ml-2 justify-start text-3xl font-bold">
                            Welcome back
                    ...
                    <div>
                        ...
                        <div className="grid h-full grid-cols-5 grid-rows-5 gap-4">
                            <div className="col-span-3 col-start-1 row-span-2 rounded-lg bg-greyscale-100">

                            </div>
                            <div className="col-span-2 col-start-4 row-span-1 rounded-lg bg-greyscale-100">
                                <div className="flex size-full items-center justify-center">
                                    <div className="flex pr-2 text-2xl font-bold">
                            ...
                            <div className="col-span-2 col-start-4 row-span-4 row-start-2 rounded-lg bg-greyscale-100">

                            </div>
                            <div className="col-span-3 row-span-3 row-start-3 rounded-lg bg-greyscale-100">
                                <div className="flex flex-col p-2">
                                    <span className="pl-4 pt-3 text-2xl font-bold">
                                    ...
                                    <span className="px-5 py-2 text-lg">
                                        ...
                                        {" "}
                                        <a href="https://google.com" target="_blank" className="text-accent-100 underline visited:text-accent-100 hover:text-accent-200">here</a>
                                    </span>
                                    <span className="px-5 py-2 text-lg">
            ...
            <Modal
                ...
                closeText="Close"
            >
                <div className="mb-4 ml-2 mt-3 flex items-center gap-2">
                ...
                <span className="mb-5 block">
                    ...
                    {" "}
                    <a href="https://google.com" target="_blank" className="text-accent-100 underline visited:text-accent-100 hover:text-accent-200">contact support</a>
                    .
                </span>
            </Modal>
        </>
