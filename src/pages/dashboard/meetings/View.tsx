...
function Meeting() {
  ...
  useEffect(() => {
    ...
    const updateDuration = () => {
      ...
      const durationStr = `${hours.toString().padStart(2, "0")}h:${minutes.toString().padStart(2, "0")}m:${seconds.toString().padStart(2, "0")}s`
  ...
  if (loading) {
    return (
      <div className="top-0 right-0 absolute flex flex-col items-center gap-10 w-full h-screen lg:usablesize">
        <Loading />
      </div>
    )
  }
  ...
  const addMemberModalContent = (
    <>
      <select
        className="block bg-greyscale-100 my-4 mb-5 border border-greyscale-200 rounded-lg w-full transition-all focus:ring-accent-100 hover:cursor-pointer"
  ...
  const qrModalContent = (
    <>
      <span className="mb-4">This is used for attendance check-in. Your club members can scan this code to attend this meeting.</span>
      ...
      <button
        className="mt-6 mr-3 px-4 py-2 rounded-lg text-white transition-colors bg-accent-100 hover:bg-accent-100"
    ...
    <PageTransition>
      ...
      <div className="top-0 right-0 absolute flex flex-col items-center gap-10 w-full h-screen lg:usablesize">
        <div className="top-[100px] absolute w-[996px] 2xl:w-[1400px] max-w-[90%]">
          ...
          <div className="bg-greyscale-100 rounded-lg outline outline-greyscale-200 w-full h-[300px]">
            ...
            <div className="flex justify-center gap-4 px-5 py-1 w-full">
              <div className="w-1/2">
                <div className="flex items-end gap-2 size-full">
                  <button
                    className="right-1 relative justify-end ml-1 px-[25px] py-[12px] rounded-lg text-[13px] transition-colors bg-accent-100 hover:bg-accent-200 disabled:bg-accent-90 disabled:hover:bg-accent-90 disabled:cursor-not-allowed"
                    onClick={() => setShowQrModal(true)}
                    disabled={meeting.endTime != null}
                  >
                    <FontAwesomeIcon
                      icon={faQrcode}
                      size="lg"
                  ...
                  <button
                    className="right-1 relative justify-end ml-1 px-[25px] py-[12px] rounded-lg text-[13px] transition-colors bg-accent-100 hover:bg-accent-200"
                  ...
                  <button
                    className="right-1 relative justify-end bg-greyscale-200 hover:bg-greyscale-300 disabled:hover:bg-greyscale-200 ml-1 px-[25px] py-[12px] rounded-lg text-[13px] text-warningred transition-colors disabled:cursor-not-allowed"
              ...
              <div className="w-1/2">
                <textarea
                  className="bg-greyscale-200 border-none rounded-lg focus:ring-2 w-full h-36 transition-all focus:ring-accent-100 resize-none"
                ...
                <div className="flex justify-between items-center mt-2">
                  {club.volunteering && (
                    <span className="text-lg">
                      ...
                      <input
                        type="checkbox"
                        className="shadow-xs ml-2 border-0 rounded-md ring-1 ring-gray-300 focus:ring-2 ring-inset focus:ring-inset size-6 transition-all text-accent-100 focus:ring-accent-200 hover:cursor-pointer"
                  ...
                  <button
                    className="right-0 relative justify-end px-[25px] py-[12px] rounded-lg text-[13.5px] transition-colors bg-accent-100 hover:bg-accent-200"
          ...
          <div className="flex items-center mt-4">
            ...
            <input
              type="checkbox"
              className="shadow-xs mb-0 ml-2 border-0 rounded-md ring-1 ring-gray-300 focus:ring-2 ring-inset focus:ring-inset size-5 transition-all text-accent-100 focus:ring-accent-200 hover:cursor-pointer"
