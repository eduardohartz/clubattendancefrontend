        ...
        <>
            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <Link to="/"><img className="mx-auto h-auto rounded-md w-16" src="/logo.png" alt="Club Attendance"></img></Link>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="flex w-full justify-center rounded-md bg-accent-100 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-accent-200 transition-colors"
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                        ...
                        <Link to="/setup"><span className="font-semibold text-accent-200 hover:bg-accent-100 transition-colors"> Click here</span></Link>
                    </p>
                </div>
            </div>
        </>
