        ...
        <>
            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <Link to="/"><img className="mx-auto h-12 w-auto rounded-md" src="/logo.png" alt="Club Attendance"></img></Link>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-between">
                                <label htmlFor="rpassword" className="mt-1 block text-sm/6 font-medium text-gray-900">Repeat password</label>
                            </div>
                            <div className="mt-2">
                                <input
                                    id="rpassword"
                        ...
                        <div>
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="block size-6 rounded-md border-0 text-accent-100 shadow-sm ring-1 ring-inset ring-gray-300 transition-all focus:ring-2 focus:ring-inset focus:ring-accent-200"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="lex bg-bg-accent-100 w-full justify-center rounded-md bg-accent-100 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm transition-colors hover:bg-accent-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-200"
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500">
                        ...
                        <a href="mailto:support@clubattendance.com?subject=Requesting%20access&body=Hi!%0A%0AI%20run%20the%20club%20%5B%5D%20at%20the%20school%20%5B%5D.%20Can%20I%20request%20early%20access%20to%20your%20program%3F%0A%0AThanks!">
                            <span className="hover:text-bg-accent-100 font-semibold text-accent-200 transition-colors"> Request an account</span>
                        </a>
                    </p>
                    <p className="mt-2 text-center text-sm/6 text-gray-500">
                        Already have an account?
                        <Link to="/login"><span className="hover:text-bg-accent-100 font-semibold text-accent-200 transition-colors"> Login</span></Link>
                    </p>
                </div>
            </div>
        </>
